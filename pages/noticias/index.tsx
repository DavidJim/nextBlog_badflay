	...
	return (
		<section className="container mx-auto py-12 md:py-6 md:pt-0 text-center border-b">
								...
								<div className="flex flex-wrap space-x-1 my-2 items-start">
									{posts[0].categories.nodes.map((category: any) => {
										return (
											<p
												key="key"
												className="bg-purple-800 items-center text-[0.5rem]/[0.5rem] text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3 mb-2 md:mb-0
						...
						return (
							...
							>
								<img
									...
									className="shadow-md object-cover w-full mb-2 overflow-hidden rounded-lg shadow-sm max-h-56 btn- transition-all duration-200 ease-linear hover:-translate-y-[3px]"
								/>
								<div key="key" className="col-span-12 flex flex-wrap">
									<div className="flex flex-wrap space-x-1 my-2 items-start">
            ...
            rounded-full uppercase"
								...
								<a className="font-bold sm:text-2xl md:text-2xl">
									{post.title}
								</a>
								<div
...
export const getStaticProps: GetStaticProps = async () => {
	const posts = await getNews(1); // retrieve first 100 posts
