export default function Privacidad({ posts }: { posts: any }) {
	return (
		<section className="container mx-auto py-12 md:py-6 md:pt-0 text-center border-b">
			<div className="w-full pt-4 pr-5 pb-6 pl-5 mt-0 mr-auto mb-0 ml-auto space-y-5 sm:py-8 md:pt-12 sm:space-y-8 md:space-y-16 max-w-7xl">
				<div className="relative flex pt-20 md:py-5 items-center">
					...
					<div>Política de privacidad y cookies</div>
					<div className="flex-grow border-t border-gray-400 ml-2"></div>
				</div>
			</div>
			<div className="justify-center items-center text-justify px-2 xl:px-24 mx-4 mb-6 text-black text-[1rem] pt-4">
				<p>
					<strong>POLÍTICA DE PRIVACIDAD</strong>
				</p>
				<p>
					El presente Política de Privacidad establece los términos en que CD
					Badflay usa y protege la información que es proporcionada por sus
				...
				<p>
					...
					Nombre&nbsp; e información de contacto como&nbsp; su dirección de
					correo electrónica. Esta información solo será recopilada a través del
					formulario de contacto, con fines de poder responder a los mensajes.
				</p>
				<p>
				...
				<p>
					...
					contactos, y mejorar nuestros productos y servicios. &nbsp;Es posible
					que sean enviados correos electrónicos periódicamente a través de
				...
				<p>
					CD Badflay está altamente comprometido para cumplir con el compromiso
				...
				<p>
					CD Badflay Se reserva el derecho de cambiar los términos de la
