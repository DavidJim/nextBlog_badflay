...
export default function Club({ posts }: { posts: any }) {
	...
	return (
		<>
			<Head>
				<title>Sobre el Club y Escuelas del Bádminton Badflay de Jaén</title>
				<meta
					property="og:title"
					content="Sobre el Club y Escuelas del Bádminton Badflay de Jaén"
				/>
				<meta
					...
					<div className="lg:w-1/2 lg:max-w-[40%]">
						...
						<div className="justify-center items-center text-justify px-2 mx-4 mb-6 text-black text-[1rem] pt-4">
							{activeTab === 1 ? (
								<span>
									<p className="mb-2">
										El Club Badflay Jaén es el club de bádminton de la capital
										del Santo Reino.
									</p>
									<p className="mb-2">
										A lo largo de sus más de 35 años de historia, ha competido a
										nivel provincial, autonómico y nacional en todas las
										categorías, donde jugadores de la provincia y otros lugares
										del país e incluso del mundo han podido disfrutar de este
										deporte, desde los más jóvenes en las escuelas municipales
										hasta los más veteranos en la categoría Sénior, donde el
										club es referente a nivel nacional.
									</p>
									<p className="mb-2">
										Actualmente, en la temporada 2024/2025, el primer equipo
										absoluto compite en Primera División Nacional Bronce, tras
										haber conseguido el ascenso en la temporada anterior.
									</p>
								</span>
							) : (
								<span>
									...
									<p className="mb-2">
										...
										habilidades físicas, mentales y sociales clave. Nuestro
										equipo de entrenadores del primer equipo está dedicado a
										proporcionar una experiencia divertida y enriquecedora, sin
										importar el nivel de habilidad inicial.
									</p>
									<p className="mb-2">
										El bádminton es un deporte emocionante y dinámico que
										promueve la agilidad, la coordinación, la táctica y la
										estrategia. Además, es una excelente manera de fomentar la
										disciplina, la concentración y el compañerismo, valores
										deportivos muy importantes en cualquier ámbito.
									</p>
									<p className="mb-2">
