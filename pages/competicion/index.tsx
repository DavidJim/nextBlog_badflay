...
export default function Competicion() {
	...
	return (
		<>
			<Head>
				<title>Competiciones del Club Bádminton Badflay Jaén</title>
				<meta
					property="og:title"
					content="Competiciones del Club Bádminton Badflay Jaén"
				/>
				<meta
					property="og:description"
					content="Próximas competiciones del Club Bádminton Badflay Jaén"
				/>
				<meta
					property="og:image"
